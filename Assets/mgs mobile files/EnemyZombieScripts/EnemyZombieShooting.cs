...
public class EnemyZombieShooting : MonoBehaviour
{
	...
	*/
	...
	void Shoot ()
	{
		...
		float fractionalDistance = (col.radius - Vector3.Distance(transform.position, player.transform.position)) / col.radius;
